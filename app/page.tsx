...
export default function Home() {
	...
	return (
		<main className="relative min-h-screen overflow-hidden bg-black text-white">
			...
			<div className="relative flex min-h-screen flex-col justify-end px-6 pb-10 pt-20 md:items-end md:px-20 md:pb-16 md:pt-0">
				...
				<div
					id="vpWrapper"
					className="mt-10 self-center translate-y-2 opacity-0 transition-all duration-700 [transition-timing-function:cubic-bezier(0.22,1,0.36,1)] md:mt-14"
				>
					<Link
						id="vpLink"
						href="/gateway"
				...
				<div className="mt-10 self-start text-[12px] text-white/36 md:mt-16 md:text-[14px]">
					<span ref={sigRef} />
				</div>
			</div>
		</main>
